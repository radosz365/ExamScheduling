...
def test_columns_removed():
    ...
    assert "primary_color" not in saved_df.columns, "The 'primary_color' column was not removed."
    assert "secondary_color" not in saved_df.columns, "The 'secondary_color' column was not removed."
    os.remove(output_path)
